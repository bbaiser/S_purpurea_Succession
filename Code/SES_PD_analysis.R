...
#call in data
#the pitcher by ASV table (rows are pitchers n=515, columns are ASVs n=3376)
asv <- read.table ("Data/pitcher_plant_ASV_table.csv", sep= ",", check.names = F,row=1, header =T)
dim(asv)

#meta is the covariate data associated with each pitcher (n=515)
meta <- read.table("Data/pitcher_plant_meta_table.csv", sep= ",", header=T)
dim(meta)

#phylogenetic tree for the ASVs
asv16s.tree <- read.tree("Data/pitcher_plant_tree.nwk")
...
#write.csv(pitcher_pd, "Data/PD_QC.csv")
...
#write.csv(pitcher_pd, "Data/PD_FL.csv")
...
#write.csv(pitcher_pd, "Data/PD_GA.csv")
...
#write.csv(pitcher_pd, "Data/PD_IN.csv")
...
#write.csv(pitcher_pd, "Data/PD_MA.csv")
...
#write.csv(pitcher_pd, "Data/PD_NC.csv")
...
#write.csv(pitcher_pd, "Data/PD_WI.csv")